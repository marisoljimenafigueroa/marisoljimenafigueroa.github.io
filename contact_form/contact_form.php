...
// configure
$from = 'marisol@marisolfigueroa.com'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'marisol@marisolfigueroa.com'; // Replace it with Your email. REQUIRED!
